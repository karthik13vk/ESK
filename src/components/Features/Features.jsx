                ...
                <Container>
                    <Grid container spacing={4} columns={12} className="" alignItems="center">
                        <Grid item size={{ xs: 12, lg: 12, md: 12 }} alignItems="center">
                            <div className='flex flex-col items-start gap-5 mb-6 heading-section lg:flex-col' >
                                    ...
                                    >
                                        <div className="flex flex-col items-center justify-between lg:flex-row">
                                            <div className={`feature-box lg:w-[40%] w-full flex items-center gap-10 text-[24px] pl-1.5
                                             font-medium leading-[36px] py-6 border-t-1 border-t-black-500 lg:border-t-0   transition-all duration-300 ${index === activeIndex ? ' border-l-4 border-primary' : ''}`}>
                                               <h3
  className={`mb-2 text-2xl font-semibold transition-all ${
    index === activeIndex ? 'text-primary lg:text-primary' : 'text-white lg:text-black'
  }`}
>
  {feature.title}
</h3>
                                            ...
                                            <div
                                                className={`feature-img  lg:max-w-[950px] absolute lg:right-[-25%] lg:bottom-[-60px] 
                                                lg:z-[1] right-0 top-0 -z-10 transition-all duration-500 ${index === activeIndex ? 'opacity-100 visible' : 'opacity-0 invisible'
                                                    }`}>
                                                <img src={feature.banner} alt="img" className="object-cover min-h-120 lg:min-h-min "  loading="lazy" />
                                                <div className="feature-img-content lg:absolute bottom-0 left-[-100px] right-0
                                                 lg:flex items-end justify-between lg:flex-row  flex-col gap-2 hidden">
